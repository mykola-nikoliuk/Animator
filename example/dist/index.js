...
/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(3),
    stubFalse = __webpack_require__(34);
...
// EXTERNAL MODULE: ./node_modules/event-emitter-es6/index.js
var event_emitter_es6 = __webpack_require__(18);
var event_emitter_es6_default = /*#__PURE__*/__webpack_require__.n(event_emitter_es6);

// CONCATENATED MODULE: ./src/utils/eventEmmiter.js

class eventEmmiter_EventEmitter extends event_emitter_es6_default.a {
  /**
   *
   */
  constructor() {
...
// CONCATENATED MODULE: ./src/utils/renderLoopScope.js


class renderLoopScope_RenderLoopScope extends eventEmmiter_EventEmitter {
  ...
  emitUpdate(dTime) {
    const isExistListeners = get_default()(this, '_listeners.update.length');
...
// CONCATENATED MODULE: ./src/utils/renderLoop.js
...
class renderLoop_AnimationLoop extends eventEmmiter_EventEmitter {
  constructor() {
    super();
  ...
  addScope(namespace) {
    const scope = new renderLoopScope_RenderLoopScope(namespace, this.scopes);
    this.scopes[namespace] = scope;
    this.scopeRegister[namespace] = scope; //initial render
...
/* harmony default export */ var renderLoop = (new renderLoop_AnimationLoop());
...
class Animation_Animation {
  ...
  _animationUpdate(progress) {
    each_default()(this.updateFunctions, (updateFunction, key) => {
      const keyframeRange = Animation_Animation._getFromToByField(key, this.keyframes, progress);
  ...
  _checkKeyframes() {
    ...
    each_default()(this.keyframes, (keyframe, index) => {
  ...
  static _getFromToByField(field, keyframes, progress) {
    ...
    let localProgress = -1;
    each_default()(keyframes, keyframe => {
